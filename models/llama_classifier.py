...
class PhishGuardClassifier(nn.Module):
    ...
    def __init__(
        ...
        try:
            ...
            self.model = AutoModelForSequenceClassification.from_pretrained(
                fallback, num_labels=num_labels
            )
    ...
    def forward(self, input_ids, attention_mask, labels=None, return_embeddings=False):
        ...
        embeddings, attention_scores = self.get_semantic_embeddings(
        ...
        outputs = {"logits": logits, "attention_scores": attention_scores}
